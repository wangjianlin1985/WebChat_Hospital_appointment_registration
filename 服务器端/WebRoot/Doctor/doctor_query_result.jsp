...
<div id="doctor_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="doctorQueryForm" method="post">
			...
			入职日期：<input type="text" id="birthDate" name="birthDate" class="easyui-datebox" editable="false" style="width:100px">
...
<div id="doctorEditDiv">
	<form id="doctorEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<textarea id="doctor_doctorDesc_edit" name="doctor.doctorDesc" rows="8" cols="60"></textarea>
