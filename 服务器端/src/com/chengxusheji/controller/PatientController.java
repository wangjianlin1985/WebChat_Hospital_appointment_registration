...
public class PatientController extends BaseController {
	...
	/*前台按照查询条件分页查询病人信息信息*/
	@RequestMapping(value = { "/doctorFrontlist" }, method = {RequestMethod.GET,RequestMethod.POST})
	public String doctorFrontlist(@ModelAttribute("doctorObj") Doctor doctorObj,String patientName,String cardNumber,String telephone,String addTime,Integer currentPage, Model model, HttpServletRequest request, HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (patientName == null) patientName = "";
		if (cardNumber == null) cardNumber = "";
		if (telephone == null) telephone = "";
		...
		doctorObj.setDoctorNumber(session.getAttribute("user_name").toString());
	    ...
	    List<Doctor> doctorList = doctorService.queryAllDoctor();
	    request.setAttribute("doctorList", doctorList);
		return "Patient/patient_doctorFrontquery_result"; 
	}
