...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Patient/patient_doctorFrontAdd.jsp" style="display:none;">添加病人信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>病人id</td><td>病人姓名</td><td>性别</td><td>身份证号</td><td>联系电话</td><td>登记时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="patientEdit('<%=patient.getPatientId() %>');"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="patientDelete('<%=patient.getPatientId() %>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="patientQueryForm" id="patientQueryForm" action="<%=basePath %>Patient/doctorFrontlist" class="mar_t15" method="post">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <textarea id="patient_illnessCase_edit" name="patient.illnessCase" rows="8" class="form-control" placeholder="请输入病人病例"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (patient, response, status) {
			if (patient) {
				...
				$("#patient_illnessCase_edit").val(patient.illnessCase);
