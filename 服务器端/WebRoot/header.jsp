...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">医院预约网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Doctor/frontlist">医生风采</a></li><!-- 
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath%>Doctor/doctor_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;医生注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Patient/patient_doctorFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;登记病人信息</a></li>
                        <li><a href="<%=basePath %>Patient/doctorFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;管理我的病人</a></li> 
                        <li><a href="<%=basePath %>OrderInfo/doctorFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;处理预约记录</a></li>
                        <li><a href="<%=basePath %>Doctor/doctor_frontSelfModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
      ...
      <div class="modal-body">
      	<form class="form-horizontal" name="loginForm" id="loginForm" enctype="multipart/form-data" method="post"  class="mar_t15">
      	  ...
      	  <div class="form-group">
			 <label for="userName" class="col-md-3 text-right">医生工号:</label>
			 <div class="col-md-9"> 
