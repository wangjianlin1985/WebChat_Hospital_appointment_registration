...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="doctorQueryForm" id="doctorQueryForm" action="<%=basePath %>Doctor/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="birthDate">入职日期:</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="doctor_birthDate_edit" class="col-md-3 text-right">入职日期:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <textarea id="doctor_doctorDesc_edit" name="doctor.doctorDesc" rows="8" class="form-control" placeholder="请输入医生介绍"></textarea>
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (doctor, response, status) {
			if (doctor) {
				...
				$("#doctor_doctorDesc_edit").val(doctor.doctorDesc);
