	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="doctor_birthDateDiv" class="col-md-2 text-right">入职日期:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 ...
				  	 <div class="col-md-8">
					    <textarea id="doctor_doctorDesc" name="doctor.doctorDesc" rows="8" class="form-control" placeholder="请输入医生介绍"></textarea>
					 </div>
				  </div>
		          <div class="form-group">
		             <span class="col-md-2""></span>
		             <span onclick="ajaxDoctorAdd();" class="btn btn-primary bottom5 top5">开始注册</span>
		          </div> 
