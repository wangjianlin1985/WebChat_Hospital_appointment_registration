		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Patient/doctorFrontlist">病人信息列表</a></li>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="patientAdd"> 
						  ...
						  <input type="hidden" name="patient.doctorObj.doctorNumber" value="<%=session.getAttribute("user_name").toString() %>">
						  ...
						  <div class="form-group">
						  	 ...
						  	 <div class="col-md-8">
							    <textarea id="patient_illnessCase" name="patient.illnessCase" rows="8" class="form-control" placeholder="请输入病人病例"></textarea>
							 </div>
						  </div>
						  <div class="form-group">
